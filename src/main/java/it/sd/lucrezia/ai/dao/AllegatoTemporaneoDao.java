...
public class AllegatoTemporaneoDao {
    ...
    public List<WhatsAppAllegatoTemporaneo> findByTelefono(String telefono) {

        List<WhatsAppAllegatoTemporaneo> lista = new ArrayList<>();
        ...
        try (
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    WhatsAppAllegatoTemporaneo a = new WhatsAppAllegatoTemporaneo();
